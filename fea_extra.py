...
class FeaMoreExtra(object):
    ...
    def compute_centralities_and_clustering(self, graph):
        ...
        alpha_centrality = nx.degree_centrality(graph)
        clustering_coefficient = nx.clustering(graph)
        return betweenness_centrality, closeness_centrality, alpha_centrality, clustering_coefficient

    def features_part3(self, u, v, betweenness_centrality, closeness_centrality, alpha_centrality, clustering_coefficient):
        betweenness_u = betweenness_centrality.get(u, 0)
        betweenness_v = betweenness_centrality.get(v, 0)
        closeness_u = closeness_centrality.get(u, 0)
        closeness_v = closeness_centrality.get(v, 0)
        alpha_u = alpha_centrality.get(u, 0)
        alpha_v = alpha_centrality.get(v, 0)
        clustering_u = clustering_coefficient.get(u, 0)
        clustering_v = clustering_coefficient.get(v, 0)
        return betweenness_u, betweenness_v, closeness_u, closeness_v, alpha_u, alpha_v, clustering_u, clustering_v
